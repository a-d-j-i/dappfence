...
!(function (e, t) {
    ...
    (ce.fn = ce.prototype =
        {
            ...
            pushStack: function (e) {
                const t = ce.merge(this.constructor(), e);
        ...
        ((b = ce.expr =
            {
                ...
                filter: {
                    TAG: function (e) {
                        const t = e.replace(O, P).toLowerCase();
                        return '*' === e
                            ? function () {
                                  return !0;
                              }
                ...
                pseudos: {
                    ...
                    target: function (e) {
                        const t = ie.location && ie.location.hash;
                ...
                F(function (e, t, n, r) {
                    let i,
                        ...
                        f =
                            e ||
                            (function (e, t, n) {
                                for (let r = 0, i = t.length; r < i; r++) I(e, t[r], n);
                                return n;
                            })(h || '*', n.nodeType ? [n] : n, []),
    ...
    ((ce.fn.init = function (e, t, n) {
        ...
        (k = ce(C));
    const E = /^(?:parents|prev(?:Until|All))/,
    ...
    const M = function (e, t, n, r, i, o, a) {
            let s = 0,
                u = e.length,
                l = null == n;
    ...
    const _e = new RegExp('^(' + G + ')(?!px)[a-z%]+$', 'i'),
        ze = /^--/,
        Xe = function (e) {
    ...
    const Qe = ['Webkit', 'Moz', 'ms'],
        Je = C.createElement('div').style,
        Ke = {};
    function Ze(e) {
        const t = ce.cssProps[e] || Ke[e];
        return (
            t ||
            (e in Je
                ? e
        ...
        var n,
            ...
            l = s.promise({
                ...
                createTween: function (e, t) {
                    const n = ce.Tween(o, l.opts, e, t, l.opts.specialEasing[e] || l.opts.easing);
    ...
    (ce.Animation = ce.extend(yt, {
        ...
        ce.fn.extend({
            ...
            animate: function (t, e, n, r) {
                const i = ce.isEmptyObject(t),
                    o = ce.speed(e, n, r),
                    a = function () {
                        const e = yt(this, ce.extend({}, t), o);
    ...
    const bt = /^(?:input|select|textarea|button)$/i,
        wt = /^(?:a|area)$/i;
    function Tt(e) {
    ...
    ce.fn.extend({
        ...
        ce.extend({
            ...
            propHooks: {
                tabIndex: {
                    get: function (e) {
                        const t = ce.find.attr(e, 'tabindex');
                        return t
                            ? parseInt(t, 10)
    ...
    const Dt = /^(?:focusinfocus|focusoutblur)$/,
        Nt = function (e) {
            e.stopPropagation();
        };
    ce.extend(ce.event, {
        ...
        simulate: function (e, t, n) {
            const r = ce.extend(new ce.Event(), n, { type: e, isSimulated: !0 });
    ...
    ce.ajaxSetup({
        ...
        jsonpCallback: function () {
            const e = Kt.pop() || ce.expando + '_' + jt.guid++;
            return (this[e] = !0), e;
        },
    }),
